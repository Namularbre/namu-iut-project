...
module.exports = [
    {
        ...
        handler: async (request, h) => {
            ...
            if (response === false) {
                return h.response('User already exists').code(403);
            } else {
                return response;
            }
        }
    ...
    },
    {
        ...
        handler: async (request, h) => {
            ...
            const response = await userService.modify(request.params['id'], request.payload);
    ...
    },
    {
        ...
        handler: async (request, h) => {
            ...
            if (isLogged) {
                ...
                const user = await userService.get(request.payload);
